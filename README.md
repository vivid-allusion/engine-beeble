...
Prompting, alpha modes, reference-image design, and source-quality best
practices: see [`USER_GUIDE.md`](USER_GUIDE.md).
...
├── USER_GUIDE.md            ← SwitchX best practices (prompting, alpha, reference)
